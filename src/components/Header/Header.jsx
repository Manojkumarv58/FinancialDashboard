    ...
    <header className="sticky top-0 z-10 border-b border-violet-200/60 bg-white/75 shadow-sm shadow-violet-200/40 backdrop-blur-md transition-colors dark:border-slate-800/80 dark:bg-slate-950/75 dark:shadow-slate-950/40">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 rounded-full border border-violet-200/80 bg-gradient-to-r from-white to-violet-50/90 px-3 py-2 text-sm shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800/90 dark:shadow-slate-950/30">
            {role === 'admin' ? (
            ...
            <select
              id="role"
              className="rounded-md bg-transparent font-medium text-violet-900 outline-none dark:text-slate-100"
              value={role}
